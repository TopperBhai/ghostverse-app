...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 relative overflow-hidden text-zinc-100 font-sans">
      ...
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] rounded-full bg-violet-600/10 blur-[100px] pointer-events-none" />
      <div className="absolute top-0 left-1/4 w-[400px] h-[400px] rounded-full bg-fuchsia-600/10 blur-[100px] pointer-events-none" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5 animate-[fadeIn_0.3s_ease-out]">
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-xl active:scale-[0.98] transition-all flex items-center justify-center disabled:opacity-70 disabled:active:scale-100 shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_25px_rgba(139,92,246,0.5)]"
              >
                {isLoading ? (
